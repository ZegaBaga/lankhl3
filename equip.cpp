...
void __fastcall TFormEquip::ADOTable1CalcFields(TDataSet *DataSet)
{
 ...
 if (ADOTable2->Locate("cod",ADOTable1->FieldByName("tip")->AsAnsiString,Opts))
 {
		ADOTable1->FieldByName("tipname")->AsAnsiString=ADOTable2->FieldByName("tipname")->AsAnsiString;
 }
// if AdotableTovar.Locate('KodTovar',AdotableKatTovar.fieldbyname('IdTovar' ).AsString,[loCaseInsensitive, loPartialKey])=true then
